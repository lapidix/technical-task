...
export const Toast = ({
  ...
  return (
    <div
      className={`${styles.bg} ${styles.border} backdrop-blur-xl shadow-lg hover:shadow-xl transition-all duration-200 rounded-lg px-4 py-3 max-w-sm mb-2 animate-slide-in-right`}>
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <p
            className={`${styles.text} text-sm font-medium whitespace-pre-line leading-snug`}>
            {message}
          </p>
        </div>
        <button
